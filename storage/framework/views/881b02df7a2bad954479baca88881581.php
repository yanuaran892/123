<form action="<?php echo e(route('home')); ?>" method="GET">
    ...
    <div class="relative">
        ...
        <input type="search" id="search" name="search"
            ...
            placeholder="Search movie title" required value="<?php echo e(request('search')); ?>">
        <button type="submit"
...
<?php /**PATH E:\UAS PAW\sea-cinema-tix-main\resources\views/components/search.blade.php ENDPATH**/ ?>